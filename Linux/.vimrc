...
" PASTE KEYBINDINGS
" ==============================================================================
" Paste from system clipboard in normal mode without losing first character
nnoremap <leader>v "+p              " Normal mode: paste after cursor
nnoremap <leader>V "+P              " Normal mode: paste before cursor
